...
\address{Astronomy and Astrophysics, Penn State University}{520 Davey Laboratory, University Park, PA 16802, USA}
%\phone{(000) 111 1112}
%\fax{(000) 111 1113}
%\mobile{+1 (412) 304-6768} 
\renewcommand*\httplink[2][]{{\urlstyle{sf}\expandafter\href#2}}
%\homepage{{http://pages.jh.edu/~bwang50}{pages.jh.edu/\string~bwang50}} %
\homepage{{https://wangbingjie.github.io}{https://wangbingjie.github.io}} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
\cvitem{}{Interstellar and circumgalactic media, galaxy formation and evolution, reionization, \newline cosmic microwave background}
...
\newline Ph.D., Astronomy \& Astrophysics, advisor: Prof. Timothy M. Heckman
...
\cvitem{2022 - present}{\textbf{The Pennsylvania State University}, University Park, PA
...
\cvline{2012 -- 2016}{Dean's honor list, University of Pittsburgh}
...
\cvline{}{\color{dgray} \href{https://ui.adsabs.harvard.edu/search/p_=0&q=orcid\%3A0000-0001-9269-5046&sort=date\%20desc\%2C\%20bibcode\%20desc}{Click here to see all papers in ADS; each title below contains an individual link.}}
...
\cvline{Others \hspace{8pt} [7]}{\href{https://ui.adsabs.harvard.edu/abs/2022ApJ...930..126F/abstract}{The Low-redshift Lyman Continuum Survey. II. new insights into LyC diagnostics} \newline S. R. Flury, et al. (including B. Wang), ApJ 930, 126 (2022)
}
\cvline{[8]}{\href{https://ui.adsabs.harvard.edu/abs/2022ApJS..260....1F/abstract}{The Low-redshift Lyman Continuum Survey I: new, diverse local Lyman-continuum emitters} \newline S. R. Flury, et al. (including B. Wang), ApJS 260, 1 (2022)
}
\cvline{[9]}{\href{https://ui.adsabs.harvard.edu/abs/2021arXiv210912133W/abstract}{The Baltimore Oriole's Nest: cool winds from the inner and outer parts of a star-forming galaxy at $z=1.3$,} \newline W. Wang, et al. (including B. Wang), arXiv:2109.12133 (2021)
}
\cvline{[10]}{\href{https://ui.adsabs.harvard.edu/abs/2019ApJ...876..126A/abstract}{On-sky performance of the CLASS Q-band telescope,} \newline J. Appel, et al. (including B. Wang), ApJ 876, 126 (2019)
}
\cvline{[11]}{\href{https://ui.adsabs.harvard.edu/abs/2018arXiv181008482K/abstract}{Fermi-LAT counterparts of IceCube neutrinos above 100 TeV,} \newline F. Krau\ss,  et al. (including B. Wang),  A\&A 620, A174  (2018)
}
...
%}
\cvitem{03/23/22}{Astrophysics Seminar (invited), University of Connecticut,\newline
{} "Implications for the epoch of reionization in the local universe,"
}
\cvitem{03/12/21}{STARs (invited), Arizona State University, \newline
...
Professor \hspace{194pt} Chair and Professor\newline
